# Skill Eval Manual Review: 2026-05-26-sonnet-4-6

- Reviewer: `TODO`
- Review date: `TODO`
- Model: `anthropic/sonnet-4-6`
- Model version: `sonnet-4-6`
- Agent: `vscode`
- Repo commit: `2b02289cfb29cf0cec60c219cecf35271271f9a7`
- Machine overall: 80.0/115.0 (69.6%)
...
- Machine score: 4.0/14.0 (28.6%)

- Machine-missed reward criteria: `one-cause-per-attempt` (2 pts), `bounded-attempts` (2 pts), `blocked-handoff-proof-gap` (2 pts), `blocked-handoff-resumable-next-step` (2 pts), `preferred-debugging-handoff-structure` (2 pts).
...
- Machine score: 6.0/10.0 (60.0%)

- Machine-missed reward criteria: `state-proof-before-patch` (1 pts), `small-safe-scope` (1 pts), `pr-review-handoff` (2 pts).
...
- Machine score: 5.0/13.0 (38.5%)

- Machine-missed reward criteria: `route-to-ship-or-decision` (3 pts), `specific-acceptance-criteria` (2 pts), `preferred-first-slice-and-route` (3 pts).
...
- Machine score: 2.0/12.0 (16.7%)

- Machine-missed reward criteria: `stop-for-human-decision` (2 pts), `preserve-safe-shaped-work` (2 pts), `say-what-remains-unshaped` (2 pts), `smallest-next-shaped-task` (2 pts), `preferred-blocker-shape-structure` (2 pts).
